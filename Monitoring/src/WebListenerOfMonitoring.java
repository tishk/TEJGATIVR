 ...
 */
public class WebListenerOfMonitoring {
    strUtils strutils=new strUtils();

    public WebListenerOfMonitoring() throws IOException {
     //  start();
     //   new serverWebListener();
    ...
    public  void start(){
            ...
            try {
                ...
                String host = Properties_Monitoring.getMonitoring_WebListener_IP();
                int port = Integer.valueOf(Properties_Monitoring.getMonitoring_WebListener_Port());
    ...
    class Server implements Runnable {
        ...
        private void read(SelectionKey key) throws IOException, SQLException, ClassNotFoundException {
    ...
    class QueueWorker implements Runnable {
        ...
        public void processData(Server server, SocketChannel socket, byte[] data, int count) throws SQLException, ClassNotFoundException {
    ...
    class ServerDataEvent {
        ...
        public byte[] data;
        public ServerDataEvent(Server server, SocketChannel socket, byte[] data) throws SQLException, ClassNotFoundException {
            this.server = server;
            this.socket = socket;
            this.data = data;
            String RCVMessage=new String(data);
            //new Thread(processMessage(RCVMessage));
           new ProcessRequest(RCVMessage);
            // server.send(socket,("ok\n").getBytes());
...
//
    ...
    public class serverWebListener {

        public serverWebListener(){
        ...
        private void initializeAndManageSocket() {
            ...
            try {
                serverSocket = new ServerSocket(
                                                Integer.valueOf(Properties_Monitoring.getMonitoring_WebListener_Port()));
                do {
        ...
        public class WorkingThread implements Runnable {
            ...
            public void run() {
                try {
                    ...
                    new ProcessRequest( new String(tmpreceivedBytes));
    ...
    private  class Capitalizer extends Thread {
        ...
        public void run() {
            try {
              ...
              //  loggerToFile.getInstance().logInfo("ReceiveString:"+input);
                new ProcessRequest(input);
    ...
    private  void startCapitalizeServer() throws IOException {
        ...
        int clientNumber = 0;
        ServerSocket listener = new ServerSocket(Integer.valueOf(Properties_Monitoring.getMonitoring_WebListener_Port()));
        try {
            while (true) {
