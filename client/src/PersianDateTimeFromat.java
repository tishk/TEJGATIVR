...
public  class PersianDateTimeFromat {
    ...
    public PersianDateTimeFromat(int year, int month, int day)
    {
    ...
    public String getIranianDateForBalance(){
        try{
            String y=String.valueOf(irYear);
            y=y.substring(2);
            irYear=Integer.valueOf(y);
