...
public class MainMQ {
    ...
    public static  void Init() throws Exception {
       ...
       /* String logPath=PropertiesUtils.getLogConfigurePath();
        PropertyConfigurator.configureAndWatch(logPath, 5000L);
        log.error("here");*/
    ...
    private  static   Object callService(String request, String msgSeq, String channelId) throws SenderException {
    ...
    public static  AccountListMessage getAccountList(String accountNumber, String accountPass, String channelType, String channelPass, String channelID, String msgSeq, String requestDateTime, String encAlgorytm, String MAC) throws SenderException, InvalidParameterException, ResponseParsingException {
        ValidateBaseParameters(channelType, channelPass, channelID);
        String xmlRequest ="";

            xmlRequest= message2XMLConvertor.GenerateAccountListRequest(accountNumber, accountPass, channelType, channelPass, channelID, msgSeq, requestDateTime, encAlgorytm, MAC);
    ...
    public static  String getAccountListStr(String accountNumber, String accountPass, String channelType, String channelPass, String channelID, String msgSeq, String requestDateTime, String encAlgorytm, String MAC) {
        try {
    ...
    public static  BalanceMessage getBalance(String accountNumber, String accountPass, String requestDateTime, String channelType, String channelPass, String channelID, String msgSeq, String encAlgorytm, String MAC)  {
        String temp="";
        try {
            ...
            // message2XMLConvertor = new Message2XMLConvertor();
               ...
               xmlRequest=   message2XMLConvertor.GenerateBalanceRequest(accountNumber, accountPass, requestDateTime, channelType,
    ...
    public static  String getBalanceStr(String accountNumber, String accountPass, String requestDateTime, String channelType, String channelPass, String channelID, String msgSequence, String encAlgorytm, String MAC) throws Exception {
    ...
    public static  String getPanStr(String msgSeq, String chnType, String chnId, String chnPass, String accNo, String accPass, String reqDateTime, String encAlgrthm, String mac) {
        try {
    ...
    public static  CardAccountMessage getPan(String msgSeq, String chnType, String chnId, String chnPass, String accNo, String accPass, String reqDateTime, String encAlgrthm, String mac) throws InvalidParameterException, ResponseParsingException, SenderException {
        try{
    ...
    public static  String getCardAccNoStr(String msgSeq, String chnType, String chnId, String chnPass, String pan, String reqDateTime, String encAlgrthm, String mac) {
        try {
    ...
    public static  CardAccountMessage getCardAccNo(String msgSeq, String chnType, String chnId, String chnPass, String pan, String reqDateTime, String encAlgrthm, String mac) throws InvalidParameterException, ResponseParsingException, SenderException {
        try{
            ValidateBaseParameters(chnType, chnPass, chnId);
    ...
    public static  RegistrationMessage getRegistration(String accountNumber, String accountPass, String serviceType, String requestDateTime, String channelType, String channelPass, String channelID, String msgSequence, String encAlgorytm, String MAC) throws SenderException, InvalidParameterException, ResponseParsingException {
    ...
    //register account
    public static  String getRegistrationStr(String accountNumber, String accountPass, String serviceType, String requestDateTime, String channelType, String channelPass, String channelID, String msgSequence, String encAlgorytm, String MAC) {
        try {
    ...
    public static  String FollowUpStr(String srcAccountNumber, String dstAccountNumber, String followUpCode, String accountPass, String origTransDateTime, String requestDateTime, String channelType, String channelPass, String channelID, String msgSequence, String encAlgorytm, String MAC) {
        try {
    ...
    public static  String RTGSFollowUpStr(String msgSeq, String chnType, String chnId, String chnPass, String srcBnkId, String srcAccNo, String dstBnkId, String dstAccNo, String followUpCode, String reqDateTime, String encAlgorithm, String MAC) {
        try {
    ...
    public static  RTGSFollowUpMessage RTGSFollowUp(String msgSeq, String chnType, String chnId, String chnPass, String srcBnkId, String srcAccNo, String dstBnkId, String dstAccNo, String followUpCode, String reqDateTime, String encAlgorithm, String MAC) throws SenderException, InvalidParameterException, ResponseParsingException {
        try{
            ValidateBaseParameters(chnType, chnPass, chnId);
    ...
    //Bill PaymentOBJ
    public static  String BillPaymentStr(String msgSequence, String srcAccount, String accountPass, String requestDateTime, String channelType, String channelPass, String channelID, String amount, String billID, String paymentID, String encAlgorytm, String MAC) {
        try {
    ...
    public static  BillPaymentValidation BillPaymentValidation(String msgSequence, String srcAccount, String accountPass, String requestDateTime, String channelType, String channelPass, String channelID, String amount, String billID, String paymentID, String encAlgorytm, String MAC) throws SenderException, InvalidParameterException, ResponseParsingException {
    ...
    public static  String BillPaymentValidationStr(String msgSequence, String srcAccount, String accountPass, String requestDateTime, String channelType, String channelPass, String channelID, String amount, String billID, String paymentID, String encAlgorytm, String MAC) {
        try {
    ...
    public static  ChequeStatusMessage getChequeStatus(String accountNumber, String accountPass, String channelType, String channelPass, String channelID, String chequeNo, String chequeAmnt, String chequeOpDate, String requestDateTime, String msgSeq, String encAlgorytm, String MAC) throws SenderException, InvalidParameterException, ResponseParsingException {
        try{
            ValidateBaseParameters(channelType, channelPass, channelID);
    ...
    //get Cheque Status
    public static  String getChequeStatusStr(String accountNumber, String accountPass, String channelType, String channelPass, String channelID, String chequeNo, String chequeAmnt, String chequeOpDate, String requestDateTime, String msgSequence, String encAlgorytm, String MAC) {
        try {
    ...
    public static  String achFollowupByTrackIdStr(String msgSequence, String chnType, String chnPass, String ChnId, String trackId, String reqDateTime, String encAlgrthm, String mac) {
        try {
    ...
    public static  ACHFundTransferMessage achFollowupByTrackId(String msgSequence, String chnType, String chnPass, String ChnId, String trackId, String reqDateTime, String encAlgrthm, String mac) throws InvalidParameterException, ResponseParsingException, SenderException {
        ValidateBaseParameters(chnType, chnPass, ChnId);
    ...
    public static  FundTransferNoCostMessage FundTransferNoCost(String srcAccountNumber, String dstAccountNumber, String transAmount, String currency, String transDesc, String accountPass, String channelType, String channelPass, String channelID, String opCode, String fPayCode, String sPayCode, String followupCode, String shpInf, String requestDateTime, String encAlgorytm, String MAC, String msgSeq,String ftype) throws SenderException, InvalidParameterException, ResponseParsingException {
        ValidateBaseParameters(channelType, channelPass, channelID);
        String xmlRequest = message2XMLConvertor.GenerateFundTransferNoCostRequest(
        srcAccountNumber, dstAccountNumber, transAmount, currency,ftype, transDesc, accountPass, channelType, channelPass, channelID, opCode, fPayCode, sPayCode, shpInf, followupCode,requestDateTime, encAlgorytm, MAC, msgSeq);



        Object response = callService(xmlRequest, msgSeq, channelID);
        FundTransferNoCostMessage responseMessage;
        if(response instanceof FundTransferNoCostMessage) {
            responseMessage = (FundTransferNoCostMessage)response;
        } else if(response instanceof BaseMessage) {
            responseMessage = xml2MessageConvertor.getResponseFundTransferNoCost(((BaseMessage)response).getResponseXml());
            responseMessage.setResponseXml(((BaseMessage)response).getResponseXml());
        } else {
            responseMessage = xml2MessageConvertor.getResponseFundTransferNoCost(response.toString());
            responseMessage.setResponseXml(response.toString());
        }
        responseMessage.setRequestXml(xmlRequest);
        log.info("Response =" + responseMessage.getResponseXml());
    ...
    //found transfer NO Cost
    public static  String FundTransferNoCostStr(String srcAccountNumber, String dstAccountNumber, String transAmount, String currency, String transDesc, String accountPass, String channelType, String channelPass, String channelID, String opCode, String fPayCode, String sPayCode, String shpInf, String requestDateTime, String encAlgorytm, String MAC, String msgSeq) {
        try {
            FundTransferMessage e = FundTransfer(srcAccountNumber, dstAccountNumber, transAmount, currency, transDesc, accountPass, channelType, channelPass, channelID, opCode, fPayCode, sPayCode, shpInf, requestDateTime, encAlgorytm, MAC, msgSeq);
            return e.getResponseXml();
        } catch (Exception var18) {
    ...
    public static  String blockAccountStr(String msgSeq, String chnType, String chnId, String chnPass, String accNo, String accPass, String blckMode, String reqDateTime, String encAlgthm, String mac) {
        try {
    ...
    //Block Account
    public  static  AccountMessage blockAccount(String msgSeq, String chnType, String chnId, String chnPass, String accNo, String accPass, String blckMode, String reqDateTime, String encAlgthm, String mac) throws InvalidParameterException, ResponseParsingException, SenderException {
        ValidateBaseParameters(chnType, chnPass, chnId);
    ...
    public static  String ACHFollowupStr(String msgSequence, String chnType, String chnPass, String chnId, String srcIBaAN, String accPass, String dstIBAN, String followupCode, String reqDateTime, String encAlgthm, String mac) {
        try {
    ...
    public static  ACHFundTransferMessage ACHFollowup(String msgSequence, String chnType, String chnPass, String chnId, String srcIBaAN, String accPass, String dstIBAN, String followupCode, String reqDateTime, String encAlgrthm, String mac) throws InvalidParameterException, ResponseParsingException, SenderException {
        ValidateBaseParameters(chnType, chnPass, chnId);
    ...
    public static  void reconnect() throws JMSException {
