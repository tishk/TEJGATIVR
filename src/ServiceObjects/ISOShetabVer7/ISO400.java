...
public class ISO400  implements Serializable {
    ...
    public  String getSabaSupplementaryData(){
        ...
        SabaSupplementaryData="14"+"00"+"98"+"9379707473"+"123456"+"0123456789"+"10"+"2177331199";

        len = FixLengthWithZero(String.valueOf(SabaSupplementaryData.length()), 3);
        return len + SabaSupplementaryData;
    }
    ...
    public  void    setRequestString(){
        ...
        try {
            ...
            Request=getMessageType()+//ISO
                    ...
                    "0044006" + // LLLVar P57 Reason code
