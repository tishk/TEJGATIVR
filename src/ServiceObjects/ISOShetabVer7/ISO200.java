...
public class ISO200 implements Serializable {
    ...
    private String GetBillTypeID(String BillID){
        ...
        //according table 7 in page 10 of dacument
        switch (BillIDType){
            case 1:Result ="WA";
                break;
            case 2:Result ="EL";
    ...
    private  String getBillOrganisationCode(String BillID){
        String Result = "0";
        String organisationCode="";
        try{
            int Len=BillID.length();
            organisationCode=BillID.substring(Len-5, Len-2);
        }catch (Exception e){
            organisationCode="000";
        }
        return Result+organisationCode;
    }
    ...
    public  void    setBitmapEarly(String bitmapEarly){
    ...
    public  void    setRequestString(){
        ...
        try {
            ...
            Request=getMessageType()+//ISO
                    ...
                    getSabaSupplementaryData()+//P58
                    getShebaCode()+//P61
                    getValidationCode();//S128
    ...
    public  void    setEncryptedRequest(){
        ...
        try {
            setRequestString();  // <-- pat attention under test
    ...
    public  void    setAdditionalDataForBillPayment(String BillID,String PaymentID) {
      setBillID(BillID);
        setPayID(PaymentID);
        String additionalData="";
        //according page 10 of dacument
        additionalData="      ";            //6 char reserve
        additionalData=additionalData+"00";      //2 char language code
        additionalData=additionalData+"        ";//8 char reserve
        additionalData=additionalData+GetBillTypeID(BillID);//2 char
        additionalData=additionalData+getBillOrganisationCode(BillID);
        additionalData=additionalData+String.valueOf(BillID.length());//constant 13 fopr now
        additionalData=additionalData+BillID;
        additionalData=additionalData+String.valueOf(FixLengthWithZero(PaymentID,13).length());//constant 13 for Now
        additionalData=additionalData+FixLengthWithZero(PaymentID,13);

        AdditionalDataForBillPayment="0"+String.valueOf(additionalData.length())+additionalData;
