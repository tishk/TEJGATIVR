...
import ServiceObjects.ISOShetabVer7.ISO200;
import ServiceObjects.ISOShetabVer7.ISO210;
import ServiceObjects.ISOShetabVer7.ISO400;
 ...
 */
public class SendToSabaSwitchVer7 {
   // SendToSabaSwitchVer7 sendToSabaSwitchVer7=null;
    ...
    public SendToSabaSwitchVer7(String pan, String pin) throws UnsupportedEncodingException, SQLException, InterruptedException {
        messageType=0;
        setPann(pan);
        setPinn(pin);
        send();
    }
    public SendToSabaSwitchVer7(String hotCard, String pan, String pin) throws UnsupportedEncodingException, SQLException, InterruptedException {
        messageType=1;
        setPann(pan);
        setPinn(pin);
        send();
    }
    public SendToSabaSwitchVer7(String Pan, String Pin, String BillID, String PaymentID,String Amount) throws SQLException, UnsupportedEncodingException, InterruptedException {
        messageType=2;
        setPann(Pan);
        setPinn(Pin);
        setBillIDD(BillID);
    ...
    public SendToSabaSwitchVer7(ISO210 ISO210) throws UnsupportedEncodingException, SQLException, InterruptedException {
        messageType=3;
        setCard210(ISO210);
        send();
    }
    public SendToSabaSwitchVer7(ISO200 ISO200) throws UnsupportedEncodingException, SQLException, InterruptedException {
        messageType=4;
//ISOMessageBalance("6273531403004496000","17311");
    ...
    public SendToSabaSwitchVer7(String pan, String pin, String BillID, String PaymentID, int i) throws UnsupportedEncodingException, SQLException, InterruptedException {
        messageType=5;
    ...
    private void sendOnSocket() throws InterruptedException {
        boolean b=ConnectionToSabaVer7.sendOnSocket(ISOMessage);
        this.setSendResult(b);
    }
    ...
    private String ISOMessageBalance(final String Pan, final String Pin) throws UnsupportedEncodingException, SQLException {
        ...
        card200=new ISO200(){{
            ...
            setPin(Pin);
            seMessageType("0200");
            setBitmapEarly("F67C8181A8E1B040");
            ...
            setProcessDateTime();
            setFunctionCode("108");//according to page 6 of document
            setDeviceCode("07");
            setIDOfPayer();
            setIDOfAcceptor();
            setIDOfPayer();
            ...
            setReferenceCode();
            setIDofCardAcceptorTerminal("V000AFFE");
            setCodeOfCardAcceptorTerminal("00000000000AFFE");
            ...
            setIDOfPinCardOwner();
            //len+00+countryCode+areaCode+tellNumber+targetCityCod+TargetZipCode+len+TargerCallerID --> for test only-->according page 12,13
            String s="14"+"00"+"98"+"9379707473"+"123456"+"0123456789"+"10"+"2177331199";
            setSabaSupplementaryData("0"+ String.valueOf(s.length())+s);
            // for 108  empty value -->according page 13
            setShebaCode("");
            setValidationCode();
            setEncryptedRequest();
         }};
    ...
    private String ISOMessageHotCard(final String Pan, final String Pin) throws UnsupportedEncodingException, SQLException {
        ...
        card200=new ISO200(){{
            ...
            setBitmapEarly("F67C8181A8E1B040");//F67C8181A8E1B040
            seBitmapSecondary("0000000010000001");
            ...
            setExpireDateOfCard("00","00");
            setProcessDateTime();
            setFunctionCode("200");//??? not in dacument
            setDeviceCode("07");
            setIDOfPayer();
            setIDOfAcceptor();
            setIDOfPayer();
...
//            setCodeOfCardAcceptorTerminal(PropertiesUtils.getMerchandCode());
    ...
    private String ISOMessageBillPayment(final String Pan,final String Pin,final String billID,final String paymentID,final String amnt) throws UnsupportedEncodingException, SQLException {
        ...
        card200=new ISO200(){{
            ...
            setExpireDateOfCard("00","00");
            setProcessDateTime();
            setFunctionCode("280");//according to page 6 of dacument
            setDeviceCode("07");
            setIDOfPayer();
            setIDOfAcceptor();
            setIDOfPayer();
            ...
            setCodeOfCardAcceptorTerminal("00000000000AFFE");
            setNameAndLocationOfAcceptor("Telephone Bank        TEHRAN       THRIR");
            setAdditionalDataForBillPayment(billID,paymentID);//according page 10 of dacument
            setCodeOfCurrencyTransactionAccepter("364");
            setCodeOfCurrencyTransactionIssuer("364");
            setIDOfPinCardOwner();
            //len+00+countryCode+areaCode+tellNumber+targetCityCod+TargetZipCode+len+TargerCallerID --> for test only-->according page 12,13
    ...
    private String ISOMessageReverseFor200(final ISO200 request) throws SQLException {
        ...
        card400=new ISO400(){{
            ...
            setPin(request.getPin());
            seMessageType("0420");
            seBitmapEarly("F67C8181AEE1B0C0"); // F6788101AEE1A000");
            seBitmapSecondary("0000004210000001");
            setTransactionISOCode("170000");
            setAmountCurrencyAcceptor(request.getAmountCurrencyAcceptor());
            setAmountCurrencyCardIssuer(request.getAmountCurrencyCardIssuer());
