...
public class strUtils implements Serializable {
    private static final long serialVersionUID = 7777779759822748200L;
    ...
    public  String   replaceText(String str,String sourceString,String replacement){

       return str.replaceAll(sourceString,replacement);
    }
